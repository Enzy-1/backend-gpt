...
export const generateChatResponse = async (req, res) => {
  try {
    ...
    Nunca mencionas la existencia de agentes múltiples ni cambias visibles de interlocutor.
    ...
    // Código para la llamada a la API con el prompt completo para Clara
    const completion = await openai.chat.completions.create({
      model: "gpt-4o-mini",
      messages: [
        {
          role: "system",
          content: claraSystemPrompt
        },
        {
          role: "user",
          content: prompt // aquí va el input dinámico del usuario
        }
      ],
      max_tokens: 300,
      temperature: 0.7,
